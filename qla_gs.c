...
qla2x00_mgmt_svr_login(scsi_qla_host_t *ha)
{
	...
	qla2x00_login_fabric(ha, ha->mgmt_svr_loop_id, 0xff, 0xff, 0xfa,
	    mb, BIT_1);
...
qla2x00_fdmi_rhba(scsi_qla_host_t *ha)
{
	...
	/* Prepare common MS IOCB */
	/*   Request size adjusted after CT preparation */
	ms_pkt = qla2x00_prep_ms_fdmi_iocb(ha, 0, RHBA_RSP_SIZE);
	...
	qla2x00_get_fw_version_str(ha, eiter->a.fw_version);
...
qla2x00_fdmi_dhba(scsi_qla_host_t *ha)
{
	...
	/* Issue RPA */
	/* Prepare common MS IOCB */
	ms_pkt = qla2x00_prep_ms_fdmi_iocb(ha, DHBA_REQ_SIZE, DHBA_RSP_SIZE);
...
qla2x00_fdmi_rpa(scsi_qla_host_t *ha)
{
	...
	/* Prepare common MS IOCB */
	/*   Request size adjusted after CT preparation */
	ms_pkt = qla2x00_prep_ms_fdmi_iocb(ha, 0, RPA_RSP_SIZE);
